...
urlpatterns = [
    ...
    path('item/<int:item_pk>/trade-requests/<int:trade_req_pk>/delete/', views.reject_trade_request, name="reject_trade_request"),
    # path('trade-request/<int:pk>/delete/', views.reject_trade_request, name="reject_trade_request"),
