    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default='選択してください', on_delete=django.db.models.deletion.DO_NOTHING, to='cross_book.category', validators=[cross_book.models.Item.validate_choice], verbose_name='カテゴリ')),
